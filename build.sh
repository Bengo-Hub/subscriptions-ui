#!/usr/bin/env bash
# =============================================================================
# Subscriptions UI Build and Deploy Script
# =============================================================================
...
# =============================================================================
# Note: DevOps app name is subscription-ui (singular); image is docker.io/codevertex/subscription-ui
# =============================================================================
...
NEXT_PUBLIC_API_URL=${NEXT_PUBLIC_API_URL:-"https://pricingapi.codevertexitsolutions.com"}
