...
export default function DashboardPage() {
  ...
  const { data: subscription, isLoading: subLoading } = useQuery({
    ...
    queryFn: () => apiClient.get<Subscription>(`/api/v1/tenants/${orgSlug}/subscription`),
  });

  const { data: usage, isLoading: usageLoading } = useQuery({
    queryKey: ['usage-summary', orgSlug],
    queryFn: () => apiClient.get<UsageSummary>(`/api/v1/tenants/${orgSlug}/usage/summary`),
  });
    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href={`/${orgSlug}/usage`} className="text-sm text-primary hover:underline flex items-center gap-1">
