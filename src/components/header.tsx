      ...
      <div className="flex items-center gap-1 sm:gap-3">
        ...
        {showProfile && (
          <div className="relative" ref={profileRef}>
            ...
            >
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-400 flex items-center justify-center text-white font-bold text-xs shadow-lg shadow-primary/20 transition-transform group-hover:scale-105">
              ...
              <div className="hidden md:block text-left mr-1">
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{role || 'Customer'}</p>
              </div>
              ...
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 w-64 rounded-[1.5rem] p-3 shadow-2xl border border-slate-100 dark:border-white/5 bg-white dark:bg-slate-900 overflow-hidden">
                  <div className="mb-2 px-3 py-2">
                    ...
                    <p className="text-[10px] text-slate-400 truncate font-bold uppercase tracking-widest mt-0.5">{role || 'Customer'}</p>
                  </div>
